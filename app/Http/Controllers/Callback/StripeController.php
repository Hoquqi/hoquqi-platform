...
class StripeController extends Controller
{
            ...
            if ( $transaction_id && $action ) {
                ...
                if ( is_array($response) && $response['success'] === TRUE) {
                    ...
                    if ($action === "B") {
                        ...
                        $this->projectBid($data->user_id,$data->bid_id, $data->amount, $response['response']->id);
                    ...
                    if ($action === "S") {
                        ...
                        // Handle deposit callback
                        $this->projectSubscription($data->user_id,$data->project_id, $data->amount, $response['response']->id);
     ...
     * @return void
     */
    private function projectBid($user_id,$bid_id, $amount, $payment_id)
    {
        try {
