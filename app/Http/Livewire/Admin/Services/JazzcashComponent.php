    ...
    public function update()
    {
        try {
            ...
            if ($this->environment === 'sandbox') {
                ...
                // Set keys
                \Log::info('[Config] jazzcash.sandbox.merchant_id : ' . $this->merchant_id);
                \Log::info('[Config] jazzcash.sandbox.password : ' . $this->password);
                \Log::info('[Config] jazzcash.sandbox.integerity_salt : ' . $this->integerity_salt);
                \Log::info('[Config] jazzcash.sandbox.return_url : ' . url('callback/jazzcash'));

            } else {

                // Set keys
                \Log::info('[Config] jazzcash.live.merchant_id : ' . $this->merchant_id);
                \Log::info('[Config] jazzcash.live.password : ' . $this->password);
                \Log::info('[Config] jazzcash.live.integerity_salt : ' . $this->integerity_salt);
                \Log::info('[Config] jazzcash.live.return_url : ' . url('callback/jazzcash'));
