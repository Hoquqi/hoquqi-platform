...
class VNPayComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            // Set keys
            \Log::info('[Config] vnpay.tmn_code : ' . $this->tmn_code);
            \Log::info('[Config] vnpay.hash_secret : ' . $this->hash_secret);
            \Log::info('[Config] vnpay.environment : ' . $this->environment);
            \Log::info('[Config] vnpay.api_url : ' . $api_url);
