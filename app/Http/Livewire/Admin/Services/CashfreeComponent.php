...
class CashfreeComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            // Set keys
            \Log::info('[Config] cashfree.PG.appID : ' . $this->app_id);
            \Log::info('[Config] cashfree.PG.secretKey : ' . $this->secret_key);
            \Log::info('[Config] cashfree.PG.isLive : ' . $this->environment === 'production' ? 'true' : 'false');
