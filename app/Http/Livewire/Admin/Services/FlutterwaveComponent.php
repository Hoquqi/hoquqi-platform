...
class FlutterwaveComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            // Set keys
            \Log::info('[Config] flutterwave.public_key : ' . $this->public_key);
            \Log::info('[Config] flutterwave.secret_key : ' . $this->secret_key);
            \Log::info('[Config] flutterwave.encryption_key : ' . $this->encryption_key);
            \Log::info('[Config] flutterwave.environment : ' . $this->environment);
