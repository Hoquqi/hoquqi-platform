...
class MercadopagoComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            // Set keys
            \Log::info('[Config] mercadopago.public_key : ' . $this->public_key);
            \Log::info('[Config] mercadopago.access_token : ' . $this->access_token);
            \Log::info('[Config] mercadopago.environment : ' . $this->environment);
