...
class PaystackComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            // Set keys
            \Log::info('[Config] paystack.publicKey : ' . $this->public_key);
            \Log::info('[Config] paystack.secretKey : ' . $this->secret_key);
            \Log::info('[Config] paystack.merchantEmail : ' . $this->merchant_email);
