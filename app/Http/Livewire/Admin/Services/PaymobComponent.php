...
class PaymobComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            // Set keys
            \Log::info('[Config] paymob.api_key : ' . $this->api_key);
            \Log::info('[Config] paymob.hmac_hash : ' . $this->hmac_hash);
            \Log::info('[Config] paymob.merchant_id : ' . $this->merchant_id);
            \Log::info('[Config] paymob.iframe_id : ' . $this->iframe_id);
            \Log::info('[Config] paymob.integration_id : ' . $this->integration_id);
            \Log::info('[Config] paymob.environment : ' . $this->environment);
