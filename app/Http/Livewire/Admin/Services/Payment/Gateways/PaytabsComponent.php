...
class PaytabsComponent extends Component
{
    ...
    public function update() 
    {
        try {
            ...
            // Set keys
            \Log::info('[Config] paytabs.profile_id : ' . $this->profile_id);
            \Log::info('[Config] paytabs.server_key : ' . $this->server_key);
            \Log::info('[Config] paytabs.currency : ' . $this->currency);
            \Log::info('[Config] paytabs.region : ' . $this->region);
