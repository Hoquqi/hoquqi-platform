...
class NowpaymentsComponent extends Component
{
    ...
    // Api request link
    public $sandbox_link    = "https://api-sandbox.nowpayments.io/v1/";
    public $production_link = "https://api.nowpayments.io/v1/";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            $this->fill([
                ...
                'ipn_secret' => isset($api_settings['ipn_secret']) ? $api_settings['ipn_secret'] : null,
