...
class PaytrComponent extends Component
{
    ...
    public $env;
      ...
      // Api request link
    public $token_link  = "https://www.paytr.com/odeme/api/get-token";
    public $iframe_link = "https://www.paytr.com/odeme/guvenli/iframe_token";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            $this->fill([
                ...
                'merchant_key'  => isset($api_settings['merchant_key']) ? $api_settings['merchant_key'] : null,
                'merchant_salt' => isset($api_settings['merchant_salt']) ? $api_settings['merchant_salt'] : null,
