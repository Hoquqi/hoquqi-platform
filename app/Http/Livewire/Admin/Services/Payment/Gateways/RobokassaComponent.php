...
class RobokassaComponent extends Component
{
    ...
    // Api request link
    public $request_link = "https://auth.robokassa.ru/Merchant/Index.aspx";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            // Fill api settings
            $this->fill([
                'mrh_login' => isset($api_settings['mrh_login']) ? $api_settings['mrh_login'] : null,
                'mrh_pass1' => isset($api_settings['mrh_pass1']) ? $api_settings['mrh_pass1'] : null,
                'mrh_pass2' => isset($api_settings['mrh_pass2']) ? $api_settings['mrh_pass2'] : null,
                'inv_id'    => isset($api_settings['inv_id']) ? $api_settings['inv_id'] : null,
