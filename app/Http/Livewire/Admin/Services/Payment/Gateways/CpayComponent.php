...
class CpayComponent extends Component
{
    ...
    // Api request link
    public $request_link    = "https://www.cpay.com.mk/client/Page/default.aspx?xml_id=/mk-MK/.loginToPay/.simple/";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            $this->fill([
                ...
                'merchant_name' => isset($api_settings['merchant_name']) ? $api_settings['merchant_name'] : null,
