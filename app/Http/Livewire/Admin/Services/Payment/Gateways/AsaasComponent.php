...
class AsaasComponent extends Component
{
    ...
    // Api request link
    public $sandbox_link    = "https://sandbox.asaas.com/api/v3";
    public $production_link = "https://wwww.asaas.com/api/v3";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            $this->fill([
                ...
                'access_token' => isset($api_settings['access_token']) ? $api_settings['access_token'] : null,
