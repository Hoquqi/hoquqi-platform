...
class PaymobComponent extends Component
{
    ...
    // Api request link
    public $auth_link    = "https://accept.paymob.com/api/auth/tokens";
    public $order_link   = "https://accept.paymob.com/api/ecommerce/orders";
    public $payment_link = "https://accept.paymob.com/api/acceptance/payment_keys";
