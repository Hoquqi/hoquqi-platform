...
class FastpayComponent extends Component
{
    ...
    // Api request link
    public $sandbox_link    = "https://dev.fast-pay.cash/";
    public $production_link = "https://secure.fast-pay.cash/";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            // Fill api settings
            $this->fill([
                'merchant_mobile_no' => isset($api_settings['merchant_mobile_no']) ? $api_settings['merchant_mobile_no'] : null,
                'store_password'     => isset($api_settings['store_password']) ? $api_settings['store_password'] : null,
    ...
    public function update() 
    {
        try {
            ...
            // Set api settings
            $api_settings   = [
                'merchant_mobile_no' => $this->merchant_mobile_no,
