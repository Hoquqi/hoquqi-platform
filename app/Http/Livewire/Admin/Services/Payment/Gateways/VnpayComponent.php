...
class VnpayComponent extends Component
{
    ...
    // Api request link
    public $sandbox_link    = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    public $production_link = "https://sandbox.vnpayment.vn/merchant_webapi/merchant.html";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            // Fill api settings
            $this->fill([
                'tmn_code'    => isset($api_settings['tmn_code']) ? $api_settings['tmn_code'] : null,
                'hash_secret' => isset($api_settings['hash_secret']) ? $api_settings['hash_secret'] : null,
