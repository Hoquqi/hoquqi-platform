...
class DuitkuComponent extends Component
{
    ...
    // Api request link
    public $sandbox_link    = "https://sandbox.duitku.com/";
    public $production_link = "https://passport.duitku.com/";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            $this->fill([
                ...
                'merchant_code' => isset($api_settings['merchant_code']) ? $api_settings['merchant_code'] : null,
