...
class JazzcashComponent extends Component
{
    ...
    // Api request link
    public $return_link     = "";
    public $sandbox_link    = "https://sandbox.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform";
    public $production_link = "https://payments.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            $this->fill([
                ...
                'password'        => isset($api_settings['password']) ? $api_settings['password'] : null,
                'integerity_salt' => isset($api_settings['integerity_salt']) ? $api_settings['integerity_salt'] : null,
    ...
    public function update() 
    {
        try {
            ...
            $api_settings   = [
                ...
                'integerity_salt' => $this->integerity_salt,
                'env'             => $this->env,
                'return_link'     => url('callback/jazzcash'),
