...
class FreekassaComponent extends Component
{
    ...
    public $shop_id;
    public $merchant_api_key;
    public $merchant_password1;
    public $merchant_password2;

    // Api request link
    public $request_link = "https://pay.freekassa.ru/";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            // Fill api settings
            $this->fill([
                'shop_id'            => isset($api_settings['shop_id']) ? $api_settings['shop_id'] : null,
                'merchant_api_key'   => isset($api_settings['merchant_api_key']) ? $api_settings['merchant_api_key'] : null,
                'merchant_password1' => isset($api_settings['merchant_password1']) ? $api_settings['merchant_password1'] : null,
                'merchant_password2' => isset($api_settings['merchant_password2']) ? $api_settings['merchant_password2'] : null,
            ]);
    ...
    public function update() 
    {
        try {
            ...
            $api_settings   = [
                ...
                'merchant_password1' => $this->merchant_password1,
                'merchant_password2' => $this->merchant_password2,
