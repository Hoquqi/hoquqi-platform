...
class EcpayComponent extends Component
{
    ...
    // Api request link
    public $sandbox_link    = "https://payment-stage.ecpay.com.tw/Cashier/AioCheckOut/V5";
    public $production_link = "https://payment.ecpay.com.tw/Cashier/AioCheckOut/V5";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            // Fill api settings
            $this->fill([
                'hash_key'    => isset($api_settings['hash_key']) ? $api_settings['hash_key'] : null,
                'hash_iv'     => isset($api_settings['hash_iv']) ? $api_settings['hash_iv'] : null,
