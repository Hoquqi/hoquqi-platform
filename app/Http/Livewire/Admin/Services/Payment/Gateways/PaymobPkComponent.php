...
class PaymobPkComponent extends Component
{
    ...
    // Api request link
    public $auth_link    = "https://pakistan.paymob.com/api/auth/tokens";
    public $order_link   = "https://pakistan.paymob.com/api/ecommerce/orders";
    public $payment_link = "https://pakistan.paymob.com/api/acceptance/payment_keys";
    public $iframe_link  = "https://pakistan.paymob.com/api/acceptance/iframes";
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            $this->fill([
                ...
                'hmac_hash'      => isset($api_settings['hmac_hash']) ? $api_settings['hmac_hash'] : null,
                'merchant_id'    => isset($api_settings['merchant_id']) ? $api_settings['merchant_id'] : null,
                'iframe_id'      => isset($api_settings['iframe_id']) ? $api_settings['iframe_id'] : null,
                'integration_id' => isset($api_settings['integration_id']) ? $api_settings['integration_id'] : null,
