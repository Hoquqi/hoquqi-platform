...
class NowpaymentsComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            // Set api key
            \Log::info('[Config] nowpayments.api_key : ' . $this->api_key);

            // Set env
            if ($this->env === 'production') {
                
                // Set live settings
                \Log::info('[Config] nowpayments.live : ' . 1);
                \Log::info('[Config] nowpayments.payment_url : ' . 'https://api.nowpayments.io/v1/payment');

            } else {

                // Set sandbox settings
                \Log::info('[Config] nowpayments.live : ' . 0);
                \Log::info('[Config] nowpayments.payment_url : ' . 'https://api-sandbox.nowpayments.io/v1/payment');
