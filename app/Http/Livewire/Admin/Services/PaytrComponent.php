...
class PaytrComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            // Set keys
            \Log::info('[Config] paytr.merchant_id : ' . $this->merchant_id);
            \Log::info('[Config] paytr.merchant_key : ' . $this->merchant_key);
            \Log::info('[Config] paytr.merchant_salt : ' . $this->merchant_salt);
            \Log::info('[Config] paytr.environment : ' . $this->environment);
