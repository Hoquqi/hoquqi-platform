    ...
    public function update()
    {
        try {
            ...
            if ($this->status === 'up') {
                ...
                \Log::info('[Config] maintenance.headline : ' . str_replace(["'", '"'], '', $this->headline));
                \Log::info('[Config] maintenance.message : ' . str_replace(["'", '"'], '', $this->message));
                \Log::info('[Config] maintenance.secret : ' . $secret);
