...
class AuthComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            // Write config
            \Log::info('[Config] services.facebook.client_id : ' . $this->facebook_client_id);
            \Log::info('[Config] services.facebook.client_secret : ' . $this->facebook_client_secret);
            \Log::info('[Config] services.facebook.redirect : ' . url('auth/facebook/callback'));
            \Log::info('[Config] services.twitter.client_id : ' . $this->twitter_client_id);
            \Log::info('[Config] services.twitter.client_secret : ' . $this->twitter_client_secret);
            \Log::info('[Config] services.twitter.redirect : ' . url('auth/twitter/callback'));
            \Log::info('[Config] services.google.client_id : ' . $this->google_client_id);
            \Log::info('[Config] services.google.client_secret : ' . $this->google_client_secret);
            \Log::info('[Config] services.google.redirect : ' . url('auth/google/callback'));
            \Log::info('[Config] services.github.client_id : ' . $this->github_client_id);
            \Log::info('[Config] services.github.client_secret : ' . $this->github_client_secret);
            \Log::info('[Config] services.github.redirect : ' . url('auth/github/callback'));
            \Log::info('[Config] services.linkedin.client_id : ' . $this->linkedin_client_id);
            \Log::info('[Config] services.linkedin.client_secret : ' . $this->linkedin_client_secret);
            \Log::info('[Config] services.linkedin.redirect : ' . url('auth/linkedin/callback'));
