...
class ChatComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            \Log::info('[Config] chatify.pusher.key : ' . $this->pusher_key);
            \Log::info('[Config] chatify.pusher.secret : ' . $this->pusher_secret);
            \Log::info('[Config] chatify.pusher.app_id : ' . $this->pusher_app_id);
            \Log::info('[Config] chatify.pusher.options.cluster : ' . $this->pusher_cluster);
            \Log::info('[Config] chatify.pusher.options.encrypted : ' . $this->pusher_encrypted ? 1 : 0);
