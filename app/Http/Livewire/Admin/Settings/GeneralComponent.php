...
class GeneralComponent extends Component
{
    ...
    public function update()
    {
        try {
            ...
            \Log::info('[Config] app.name : ' . $this->title);
            \Log::info('[Config] app.url : ' . url('/'));
            \Log::info('[Config] app.locale : ' . $this->default_language);
            \Log::info('[Config] app.fallback_locale : ' . $this->default_language);
