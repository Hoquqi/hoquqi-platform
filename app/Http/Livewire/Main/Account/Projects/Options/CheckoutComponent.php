...
class CheckoutComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.main.account.projects.options.checkout', [
    ...
    protected function webhook($data)
    {
        try {
            ...
            // Set cart
            $amount                    = $this->calculateExchangeAmount($payment_method);

            // Save
            $webhook                 = new ProjectSubscriptionWebhook();
            $webhook->subscription_id           = $this->subscription->id;
            $webhook->project_id           = $this->subscription->project->id;
    ...
    public function wallet()
    {
        try {
            ...
            // Get total amount
            $total_amount              = $this->subscription->total;
            ...
            $deposit->transaction_id = "SS" . uid(17);
            $deposit->payment_method = 'wallet';
            $deposit->amount_total   = $total_amount;
            $deposit->amount_fee     = 0;
            $deposit->amount_net     = $total_amount - 0;
            ...
            $subscription = ProjectSubscription::find($this->subscription->id);
            // Update subscription
            $subscription->payment_method = $deposit->payment_method;
