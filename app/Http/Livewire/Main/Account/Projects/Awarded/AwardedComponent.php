...
class AwardedComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.main.account.projects.awarded.awarded', [
    ...
    public function accept($id)
    {
        try {
            ...
            return redirect('account/projects/awarded/' . $project->pid .'/' . $project->slug)->with('success', __('messages.t_awarded_projects_warning_msg'));
