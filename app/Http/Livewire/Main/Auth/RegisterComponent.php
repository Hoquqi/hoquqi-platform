        ...
        try {
            ...
            if ($settings->verification_required) {
                ...
                if ($settings->verification_type === 'email') {
                    ...
                    return redirect('auth/register/success')->with('success', __('messages.t_register_verification_email_sent', ['email' => $this->email, 'minutes' => $settings->verification_expiry_period]));
                    ...
                    return redirect('auth/register/success')->with('success', __('messages.t_register_verification_admin_pending'));
