...
<head>
	...
	<link rel="stylesheet" href="{{ url('js/plugins/emojipanel/dist/emojipanel.css') }}" />
	<link rel="stylesheet" href="{{ url('js/plugins/file-icon-vectors/file-icon-vectors.min.css') }}" />
	<link rel='stylesheet' href="{{ url('js/plugins/nprogress/nprogress.css') }}" />
	<link rel="stylesheet" href="{{ url('css/chatify/style.css') }}" />
	<link rel="stylesheet" href="{{ url('css/chatify/'.$dark_mode.'.mode.css') }}" />
	...
	<script src="{{ url('js/chatify/autosize.js') }}"></script>
	<script defer src="{{ url('js/app.js') }}"></script>
	<script src="{{ asset('js/webcomponents-bundle.js') }}"></script>
	<script src="{{ url('js/plugins/twemoji/twemoji.min.js') }}"></script>
	<script src="{{ url('js/plugins/nprogress/nprogress.js') }}"></script>
	<script src="{{ url('js/plugins/emoji-mart/dist/browser.js') }}"></script>
