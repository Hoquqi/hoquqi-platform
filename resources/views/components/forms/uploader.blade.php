...
@pushOnce('scripts')
    ...
    {{-- Uploader Plugin --}}
    <script defer src="{{ url('js/plugins/uploader/js/jquery.fileuploader.min.js') }}" type="text/javascript"></script>
@endPushOnce

@pushOnce('styles')
    {{-- Uploader fonts --}}
    <link href="{{ url('js/plugins/uploader/font/font-fileuploader.css') }}" rel="stylesheet">

    {{-- Uploader styles --}}
    <link href="{{ url('js/plugins/uploader/css/jquery.fileuploader.min.css') }}" media="all" rel="stylesheet">
    <link href="{{ url('js/plugins/uploader/css/jquery.fileuploader-theme-thumbnails.css') }}" media="all" rel="stylesheet">
@endPushOnce
