                                    ...
                                    <div class="ltr:pl-3 rtl:pr-3">
                                        <p class="font-medium text-sm flex items-center">
                                            ...
                                            @if ($r->user->status === 'verified')
                                                <img data-tooltip-target="tooltip-account-verified-{{ $r->user->id }}" class="ltr:ml-0.5 rtl:mr-0.5 h-3.5 w-3.5 -mt-0.5" src="{{ url('img/auth/verified-badge.svg') }}" alt="{{ __('messages.t_account_verified') }}">
