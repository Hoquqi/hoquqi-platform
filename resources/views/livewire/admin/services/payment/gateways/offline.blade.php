    ...
    <div class="w-full bg-white rounded-lg shadow-sm px-10 py-12 border border-gray-200">
        <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
            ...
            <div class="col-span-12">
                ...
                {{-- Preview image --}}
                @if (payment_gateway($slug, false, true)?->logo)
                    <div class="mt-3">
                        <img src="{{ src( payment_gateway($slug, false, true)?->logo ) }}" class="h-32 rounded-lg intense cursor-pointer object-contain">
                    </div>
                @endif
            </div>
...
@if(auth()->user()->username =='ibsadmin') 
            {{-- Divider --}}
            <div class="col-span-12">
