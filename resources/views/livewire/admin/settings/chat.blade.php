            ...
            <div class="mb-14">
                ...
                <div class="mt-4">
                    <ul class="flex space-x-4 rtl:space-x-reverse text-xs text-primary-600 font-semibold">
                        ...
                        <li>
                            <a href="https://i.postimg.cc/qBbHqZ3Z/1.png" class="hover:text-black hover:underline" target="_blank">Step 2</a>
                        </li>

                        <li>
                            <a href="https://i.postimg.cc/5NXdCq59/2.png" class="hover:text-black hover:underline" target="_blank">Step 3</a>
                        </li>

                        <li>
                            <a href="https://i.postimg.cc/kgS0jJhk/3.png" class="hover:text-black hover:underline" target="_blank">Step 4</a>
                        </li>

                        <li>
                            <a href="https://i.postimg.cc/NfZh79b6/4.png" class="hover:text-black hover:underline" target="_blank">Step 5</a>
                        </li>
                    </ul>
                </div>
            </div>
