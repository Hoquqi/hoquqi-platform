                    ...
                    <div class="mt-4 text-gray-900 dark:text-gray-200 text-sm font-medium flex items-center justify-center">
                        ...
                        @if (auth()->user()->status === 'verified')
                            @php
                                $uuid = uid();
                            @endphp
                            <img data-tooltip-target="tooltip-account-verified-{{ $uuid }}" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="{{ url('img/auth/verified-badge.svg') }}" alt="{{ __('messages.t_account_verified') }}">
                ...
                <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
                    ...
                    {{-- LinkedIn --}}
                        <div class="col-span-12 px-5">
                            <x-forms.text-input 
                                :label="__('messages.t_linkedin')"
                                :placeholder="__('messages.t_enter_linkedin_profile')"
