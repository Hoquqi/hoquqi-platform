                            ...
                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                ...
                                <div class="flex items-center text-zinc-500 text-[13px] font-semibold">
                                    ...
                                    @if ($p->client->status === 'verified')
                                        <div>
                                            <img data-tooltip-target="tooltip-account-verified-{{ $p->client->uid }}" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="{{ url('img/auth/verified-badge.svg') }}" alt="{{ __('messages.t_account_verified') }}">
