			...
			<div class="h-80 w-full absolute bottom-0 xl:inset-0 xl:h-full">
				<div class="h-full w-full xl:grid xl:grid-cols-2">
					<div class="h-full xl:relative xl:col-start-2">
						<img class="h-full w-full object-cover opacity-25 xl:absolute xl:inset-0 ltr:rounded-r-lg rtl:rounded-l-lg lazy" src="{{ placeholder_img() }}" data-src="{{ url('img/start_selling/1.jpg') }}" alt="{{ __('messages.t_u_bring_the_skill_make_earn_easy') }}">
			...
			<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
				  <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
					...
					<div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
						...
						{{-- Price range --}}
						<p>
							<span class="block text-xl font-bold text-white uppercase">{{ __('messages.t_price_range_desc') }}</span>
		...
		{{-- List of sellers --}}
			...
			<div>
					<div class="group relative p-4 mb-5 min-h-[190px flex]">
						...
						<img src="{{ placeholder_img() }}" data-src="{{ url('img/start_selling/' . $seller['avatar']) }}" alt="{{ $seller['name'] }}" class="relative rounded-lg shadow object-cover lazy">
					</div>
						...
						<blockquote>
							...
							<footer class="flex items-center space-x-4 rtl:space-x-reverse">
								<div class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
									<img src="{{ placeholder_img() }}" data-src="{{ url('img/start_selling/9.jpg') }}" alt="{{ __('messages.t_fake_name_alex_saunders') }}" class="object-cover w-12 h-12 lazy">
								</div>
								<div>
			...
			<div class="border rounded-md bg-white dark:bg-zinc-800 dark:border-zinc-700 shadow-sm relative">
				...
				<div class="px-4 pt-14 pb-6 sm:px-6 sm:pb-6 relative">
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="{{ placeholder_img() }}" data-src="{{ url('img/start_selling/7.jpg') }}" alt="{{ __('messages.t_fake_name_ricky_jones') }}" class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
			...
			<div class="border rounded-md bg-white dark:bg-zinc-800 dark:border-zinc-700 shadow-sm relative">
				...
				<div class="px-4 pt-14 pb-6 sm:px-6 sm:pb-6 relative">
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="{{ placeholder_img() }}" data-src="{{ url('img/start_selling/8.jpg') }}" alt="{{ __('messages.t_fake_name_melissa_ross') }}" class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
