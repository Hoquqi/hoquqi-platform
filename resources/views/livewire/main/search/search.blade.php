                    ...
                    <div x-data="Components.menu({ open: false })" x-init="init()" @keydown.escape.stop="open = false; focusButton()" @click.away="onClickAway($event)" class="relative inline-block ltr:text-left rtl:text-right">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="ltr:origin-top-right rtl:origin-top-left absolute ltr:right-0 rtl:left-0 mt-2 w-40 rounded-md shadow-sm bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 focus:outline-none z-50" x-ref="menu-items" x-bind:aria-activedescendant="activeDescendant" role="menu" aria-orientation="vertical" tabindex="-1" @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()" @keydown.tab="open = false" @keydown.enter.prevent="open = false; focusButton()" @keyup.space.prevent="open = false; focusButton()" style="display: none;">
                            <div class="py-1" role="none">
                                ...
                                {{-- Most popular --}}
                                <a href="{{url()->current().'?q='.$q.'&rating='.$rating.'&delivery_time='.$delivery_time.'&min_price='.$min_price.'&max_price='.$max_price.'&sort_by=popular&page=1'}}" wire:click="$set('sort_by', 'popular')" type="button" class="{{ $sort_by === 'popular' ? 'text-gray-900' : 'text-gray-500' }} block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    {{ __('messages.t_most_popular') }}
                                </a>

                                {{-- Best rating --}}
                                <a href="{{url()->current().'?q='.$q.'&rating='.$rating.'&delivery_time='.$delivery_time.'&min_price='.$min_price.'&max_price='.$max_price.'&sort_by=rating&page=1'}}" wire:click="$set('sort_by', 'rating')" type="button" class="{{ $sort_by === 'rating' ? 'text-gray-900' : 'text-gray-500' }} block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    {{ __('messages.t_best_rating') }}
                                </a>

                                {{-- Best selling --}}
                                <a href="{{url()->current().'?q='.$q.'&rating='.$rating.'&delivery_time='.$delivery_time.'&min_price='.$min_price.'&max_price='.$max_price.'&sort_by=sales&page=1'}}"  wire:click="$set('sort_by', 'sales')" type="button" class="{{ $sort_by === 'sales' ? 'text-gray-900' : 'text-gray-500' }} block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    {{ __('messages.t_most_selling') }}
                                </a>

                                {{-- Newest first --}}
                                <a href="{{url()->current().'?q='.$q.'&rating='.$rating.'&delivery_time='.$delivery_time.'&min_price='.$min_price.'&max_price='.$max_price.'&sort_by=newest&page=1'}}"  wire:click="$set('sort_by', 'newest')" type="button" class="{{ $sort_by === 'newest' ? 'text-gray-900' : 'text-gray-500' }} block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    {{ __('messages.t_newest_first') }}
                                </a>

                                {{-- Oldest first --}}
                                <a href="{{url()->current().'?q='.$q.'&rating='.$rating.'&delivery_time='.$delivery_time.'&min_price='.$min_price.'&max_price='.$max_price.'&sort_by=oldest&page=1'}}" wire:click="$set('sort_by', 'oldest')" type="button" class="{{ $sort_by === 'oldest' ? 'text-gray-900' : 'text-gray-500' }} block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    {{ __('messages.t_oldest_first') }}
                                </a> 

                                {{-- Price: Low to High --}}
                                <a href="{{url()->current().'?q='.$q.'&rating='.$rating.'&delivery_time='.$delivery_time.'&min_price='.$min_price.'&max_price='.$max_price.'&sort_by=price_low_high&page=1'}}"  wire:click="$set('sort_by', 'price_low_high')" type="button" class="{{ $sort_by === 'price_low_high' ? 'text-gray-900' : 'text-gray-500' }} block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    {{ __('messages.t_price_low_to_high') }}
                                </a>

                                {{-- Price: High to Low --}}
                                <a href="{{url()->current().'?q='.$q.'&rating='.$rating.'&delivery_time='.$delivery_time.'&min_price='.$min_price.'&max_price='.$max_price.'&sort_by=price_high_low&page=1'}}"  wire:click="$set('sort_by', 'price_high_low')" type="button" class="{{ $sort_by === 'price_high_low' ? 'text-gray-900' : 'text-gray-500' }} block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
