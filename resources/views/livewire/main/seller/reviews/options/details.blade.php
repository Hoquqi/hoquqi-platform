                        ...
                        <div class="space-y-1 font-medium dark:text-white">
                            ...
                            @if ($review->user->country)
                                <div class="flex items-center text-xs text-gray-500 dark:text-gray-400">
                                    <img src="{{ placeholder_img() }}" data-src="{{ url('img/flags/' . strtolower($review->user->country->code) . '.svg') }}" alt="{{ $review->user->country->name }}" class="lazy h-3.5 ltr:mr-2 rtl:ml-2">
