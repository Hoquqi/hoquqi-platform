                    ...
                    <div>
                            ...
                            <div class="flex items-center mb-2 justify-center md:justify-normal">
                                ...
                                @if ($user->status === 'verified')
                                    <div>
                                        <img data-popover-target="popover-profile-verified-{{ $user->uid }}" data-popover-placement="bottom" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="{{ url('img/auth/verified-badge.svg') }}" alt="{{ __('messages.t_account_verified') }}">
                            ...
                            <li>
                                <div class="inline-flex items-center space-x-2 rtl:space-x-reverse">
                                    <div class="w-5 flex justify-center">
                                        <img src="{{ placeholder_img() }}" data-src="{{ url('img/flags/' . strtolower($user->country->code) . '.svg') }}" alt="{{ $user->country->name }}" class="lazy h-3">
                                    </div>
                                    <div>
                                        @if ($user->city)
                ...
                @if ($seller_loyalty)
                    <div class="px-4 pt-8 flex items-center space-x-3 rtl:space-x-reverse">
                        <div class="flex flex-shrink-0 h-16 items-center justify-center w-16">
                            <img src="{{ url('img/svg/reward-icon.svg') }}" alt="{{ $user->username }}">
                        </div>
                            ...
                            @if ($user_accounts->stackoverflow_profile)
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize">@lang('messages.t_linkedin')</span>
                                    </span>
